...
/**
 * @brief send spi data of ws2812 rgb
 * @return void
 */
void ws2812_send_spi(void);

/**
 * @brief set color of the target ws2812
 * @param led_no index of the target ws2812
 * @param r red channel of rgb
 * @param g green channel of rgb
 * @param b blue channel of rgb
 * @return void 
 */
void ws2812_pixel(uint16_t led_no, uint8_t r, uint8_t g, uint8_t b);

/**
 * @brief set color of all ws2812
 * @param r red channel of rgb
 * @param g green channel of rgb
 * @param b blue channel of rgb
 * @return void 
