...
void USART_Init(void)
{
  ...
  SET_BIT(RCC->APBENR2, RCC_APBENR2_USART1EN);
  MODIFY_REG(GPIOB->PUPDR, GPIO_PUPDR_PUPD5, GPIO_PUPDR_PUPD5_0);//01: 上拉
  CLEAR_BIT(GPIOB->MODER, GPIO_MODER_MODE5_0);  //10: 复用功能模式
  SET_BIT(GPIOB->AFR[0], GPIO_AFRL_AFSEL5_0);  //0001:AF1 USART1_TX(PB4) USART1_RX(PB5)
#endif
